...
public:
    const float velocity_constant = 2.5f;
    ...
    {
        position_ -= glm::normalize(glm::cross(front_, up_)) * getVelocity(deltaTime);
    }
    ...
    {
        position_ += up_ * getVelocity(deltaTime);
    }
...
private:
    ...
    {
        return velocity_constant * deltaTime;
    }
};
